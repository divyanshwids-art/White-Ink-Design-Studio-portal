      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md w-full">
        <div className="bg-white/95 backdrop-blur-md border border-[#EDE7DD] py-8 px-6 sm:px-10 shadow-xl rounded-2xl">
          <div className="mb-6 text-center">
            <h2 className="text-xl font-serif font-bold text-[#1C1917]">Client Portal Login</h2>
            <p className="text-xs text-[#78716C] mt-1">Access your projects, milestones, and deliverable reviews</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? 'Signing in...' : 'Enter Client Portal'}
