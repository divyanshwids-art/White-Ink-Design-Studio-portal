        ...
        <p className="font-medium">
          {enabled ? (
            <span className="text-emerald-700 flex items-center gap-1.5 font-semibold">
              ...
              Notifications enabled! You will now receive alerts even when the portal is closed.
            </span>
          ) : (
            <>
              <strong>Enable Chrome Desktop Alerts:</strong> Receive notifications for messages, approvals, and project updates even when the portal is closed.
            </>
          )}
        </p>
      </div>
